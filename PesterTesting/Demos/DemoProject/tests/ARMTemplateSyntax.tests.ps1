$templateFolder=(Split-path -parent $MyInvocation.MyCommand.Path).Replace('tests','templates')
...
foreach ($templateFile in $templateFiles) {
    Describe  -Tag 'PreDeployment' "Testing Template Content: $templateFile" {
        ...
        Context "Template Syntax" {
            ...
            For ($i = 0; $i -lt $templateContents.Length; $i++) {
                ...
                ForEach ($Match In $Matches) {
                    ...
                    if ($SquarePairCharNumber -ne 0 -or $ParenthesisPairCharNumber -ne 0) {
                        ...
                        It "$templateFile should have same amount of opening and closing  brackets (Line $($i + 1))" {
            ...
            It "$templateFile Should have no missing bracket pairs" {
        ...
        Context "Template Structure" {
            ...
            It " $templateFile should have a `$schema section" {
                $templateProperties."`$schema" | Should -Not -BeNullOrEmpty
            }
      
            It "$templateFile should have a contentVersion section" {
                $templateProperties.contentVersion | Should -Not -BeNullOrEmpty
            }
      
            It "$templateFile should have a parameters section" {
                $templateProperties.parameters | Should -Not -BeNullOrEmpty
            }
          
          
            It "$templateFile should have a variables section" {
                $templateProperties."variables" | Should -Not -BeNullOrEmpty
            }

          
            It "$templateFile should have a outputs section" {
                $templateProperties."outputs" | Should -Not -BeNullOrEmpty
            }
            It "$templateFile should have less than 256 parameters" {
        ...
        Context "Parameter and Variable Checks" {
            ...
            Context "Referenced Parameters" {
                ForEach ($parameterUsage In $parametersUsage) {
                    ...
                    It "$templateFile should have a parameter called $parameterUsage" {
