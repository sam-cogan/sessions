...
$x=New-AzureRmResourceGroupDeployment -Name "3_outputs_1" -ResourceGroupName "igniteARMDemos" -TemplateFile .\3_Outputs\objectOutput.json
...
New-AzureRmResourceGroupDeployment -Name "3_outputs_1" -ResourceGroupName "igniteARMDemos" -TemplateFile .\3_Outputs\Variables.json
